class Menu{
    ...
    desplegar(){
        ...
        for (const opcion of this.opcionesMenu) {
            if(window.innerWidth >= 320 && window.innerWidth <= 425 && window.innerHeight < 600){
                opcion.style.left= `${70 + (45 * contador)}px`;
            } else if(window.innerHeight >= 580 && window.innerWidth >= 360 && window.innerWidth <= 480 && window.innerHeight < 1024){
                opcion.style.left= `${90 + (60 * contador)}px`;
            } else if(window.innerWidth >= 650 && window.innerWidth < 1024 && window.innerHeight >= 320 && window.innerHeight <= 600 || window.innerWidth <= 650 && window.innerHeight >= 320 && window.innerHeight <= 600){
                opcion.style.left= `${90 + (60 * contador)}px`;                
            } else{
    ...
    guardar(){
        for (const opcion of this.opcionesMenu) {
            if(window.innerWidth >= 320 && window.innerWidth <= 425 || window.innerWidth >= 650 && window.innerWidth <= 900 || window.innerWidth <= 650 && window.innerHeight >= 320 && window.innerHeight <= 425 || window.innerWidth < 1024){
    ...
    desplegarColores(){
        ...
        for (const opcion of this.opcionesColores) {
            ...
            } else if(window.innerWidth >= 650 && window.innerWidth <= 900 && window.innerHeight >= 320 && window.innerHeight <= 600 || window.innerWidth <= 650 && window.innerHeight >= 320 && window.innerHeight <= 600){
                opcion.style.bottom= '70px';
            } else{
    ...
    guardarColores(){
        for (const opcion of this.opcionesColores) {
            opcion.style.visibility= 'hidden';
            if(window.innerWidth >= 320 && window.innerWidth <= 425 || window.innerWidth >= 650 && window.innerWidth <= 900 || window.innerWidth <= 650 && window.innerHeight >= 320 && window.innerHeight <= 425){
    ...
    clickCambioAnimacion(){
        if(window.innerWidth < 1024){
            swal('Lo sentimos','Esta funcion solo esta disponible para dispositivos de escritorio', 'error', {
                className: 'animacion-alert'
            });
        } else{
            this.desplegadoCambioAnimacion= !this.desplegadoCambioAnimacion;
            if(!this.desplegadoCambioAnimacion){
